...
class BankAccountHandler
{
    ...
    public function __construct(EntityManagerInterface $em, RequestStack $requestStack, LoggerInterface $logger, Security $security, StripeHandler $stripeHandler)
    {
        $this->em = $em;
    ...
    public function deleteBankAccount()
    {
        ...
        return new JsonResponse(
            ["message" =>"Account deleted", "id" => $data->id],
            201
        );
