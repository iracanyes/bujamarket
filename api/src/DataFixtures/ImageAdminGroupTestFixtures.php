...
class ImageAdminGroupTestFixtures extends Fixture implements FixtureGroupInterface
{
    private $faker;

    public const IMAGE_ADMIN_GROUP_TEST_REFERENCE = 'imageAdminGroupTest';
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->setReference(self::IMAGE_ADMIN_GROUP_TEST_REFERENCE, $image);
    }
