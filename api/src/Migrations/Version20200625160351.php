 ...
 */
final class Version20200625160351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_supplier DROP authorized_sales, CHANGE website website VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_supplier ADD authorized_sales TINYINT(1) NOT NULL, CHANGE website website VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE bjmkt_supplier_product CHANGE quantity quantity INT DEFAULT NULL');
