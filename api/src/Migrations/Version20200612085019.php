 ...
 */
final class Version20200612085019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_image ADD mime_type VARCHAR(255) NOT NULL, CHANGE supplier_product_id supplier_product_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE alt alt VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_customer_bill CHANGE order_set_id order_set_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bjmkt_forum CHANGE responder_id responder_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bjmkt_image DROP mime_type, CHANGE supplier_product_id supplier_product_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE alt alt VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
