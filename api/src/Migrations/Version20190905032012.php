 ...
 */
final class Version20190905032012 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E2A1F118E7927C74 ON bjmkt_user_temp (email)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E2A1F118E7927C74 ON bjmkt_user_temp');
