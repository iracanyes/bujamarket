 ...
 */
final class Version20190905011801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_user_temp ADD token VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_user_temp DROP token');
        $this->addSql('ALTER TABLE bjmkt_withdrawal CHANGE bill_refund_id bill_refund_id INT DEFAULT NULL, CHANGE order_delivered order_delivered TINYINT(1) DEFAULT \'NULL\'');
    }
}
