 ...
 */
final class Version20190911145654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_supplier CHANGE website website VARCHAR(255) DEFAULT NULL, CHANGE supplier_key supplier_key VARCHAR(255) NOT NULL, CHANGE trade_register_number trade_registry_number VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_order_returned CHANGE bill_refund_id bill_refund_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bjmkt_supplier CHANGE website website VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, CHANGE supplier_key supplier_key VARCHAR(50) NOT NULL COLLATE utf8_unicode_ci, CHANGE trade_registry_number trade_register_number VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE bjmkt_supplier_product CHANGE quantity quantity INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE bjmkt_user_temp CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
        $this->addSql('ALTER TABLE bjmkt_withdrawal CHANGE bill_refund_id bill_refund_id INT DEFAULT NULL, CHANGE order_delivered order_delivered TINYINT(1) DEFAULT \'NULL\'');
    }
}
