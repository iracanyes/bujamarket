 ...
 */
final class Version20190920190857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_shopping_card DROP INDEX IDX_AF6948EF9395C3F3, ADD UNIQUE INDEX UNIQ_AF6948EF9395C3F3 (customer_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_order_returned CHANGE bill_refund_id bill_refund_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bjmkt_shopping_card DROP INDEX UNIQ_AF6948EF9395C3F3, ADD INDEX IDX_AF6948EF9395C3F3 (customer_id)');
