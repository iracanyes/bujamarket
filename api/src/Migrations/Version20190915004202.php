 ...
 */
final class Version20190915004202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_supplier_product ADD rating DOUBLE PRECISION NOT NULL, CHANGE quantity quantity INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bjmkt_supplier_product DROP rating, CHANGE quantity quantity INT DEFAULT NULL');
