...
class SubscribeCustomerForm extends React.Component {
  static propTypes = {
  ...
  handleSubmit(e)
  {
    ...
    //const { user } = this.state;
    const data = new FormData(document.getElementById('subscribe-customer-form'));
    ...
    return (
      <Fragment>
        <div className={"user-authentication-form my-3"}>
          ...
          <h1>
            <FormattedMessage  id={"app.page.user.subscribe.customer.title"}
                               defaultMessage="Devenir membre : Client"
                               description="Page User - Subscribe customer title"
            />
          </h1>
          {this.props.error && (
...
export default connect(mapStateToProps, mapDispatchToProps)(
  reduxForm({
    form: 'subscribe-customer',
    enableReinitialize: true,
    keepDirtyOnReinitialize: true
  })(injectIntl(SubscribeCustomerForm))
)
